  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.country == null ? "Country" : variables.country
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://github.com/"><i class="fab fa-github"></i>${
              variables.github == null ? "" : variables.github
            }</a></li>
            <li><a href="https://linkedin.com/"><i class="fab fa-linkedin"></i>${
              variables.linkedin == null ? "" : variables.linkedin
            }</a></li>
            <li><a href="https://instagram.com/"><i class="fab fa-instagram"></i>${
